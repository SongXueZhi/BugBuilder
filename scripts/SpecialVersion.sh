...
do
 ...
 for s in ${arr[@]}
  ...
  defects4jPath="/home/sxz/data/defects4j/framework/bin/defects4j"
  BugBuilderPath="/home/sxz/IdeaProjects/bugbuilder" # Path to BugBuilder, i.e., where it's source code has been placed
